    ...
    <div className='home'>
      ...
      <div className="features">
        <div className="container">
          ...
          <div className="item">
            <video poster='https://quickgigs-res.cloudinary.com/q_auto,f_auto,w_700,dpr_1.0/v1/attachments/generic_asset/asset/089e3bb9352f90802ad07ad9f6a4a450-1599517407052/selling-proposition-still-1400-x1.png' src="./media/video.mp4" controls></video>
          </div>
        </div>
      </div>

      {/* QuickGigs Business Component */}
      <div className="features dark">
        <div className="container">
          <div className="item">
            <h2>quickgigs business</h2>
            ...
            <button>Explore QuickGigs Business</button>
          </div>
          <div className="item">
            <img src="https://quickgigs-res.cloudinary.com/q_auto,f_auto,w_870,dpr_1.0/v1/attachments/generic_asset/asset/d9c17ceebda44764b591a8074a898e63-1599597624757/business-desktop-870-x1.png" alt="" />
          </div>
        </div>
      </div>
