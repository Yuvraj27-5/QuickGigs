...
![cover](https://i.ibb.co/16SWfbg/QuickGigs-Gif.gif)
...
The project repository can be found in [GitHub link](https://github.com/zuhedshaikh95/quickgigs-clone) or just clone the project using this command.

```
Using HTTPS

# git clone https://github.com/zuhedshaikh95/quickgigs-clone.git
```

- Open terminal on your workspace with

```
cd /home/workspace/quickgigs-clone
```
